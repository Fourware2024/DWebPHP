...
$baseUrl = (isset($_SERVER['HTTPS']) ? "https://" : "http://") . $_SERVER['HTTP_HOST'] . '/PayPal2';

// Función para obtener el token de acceso de PayPal
function getPayPalAccessToken()
{
    // Credenciales de la aplicación PayPal (clientId y secret)
    $clientId = 'Aeo1GCOwoLEu_hcMSIWXy_FWZyWD59LI_UjpTH3gGaTVvfJOGQOFPsvA-5sNjzhs0zysZ_4tSVhVPW20';
    $secret = 'EE6kzuYv2O4V1RxsSIqfigHvowex-Gsw_Jb0i0xS24eMZ8XlQ0PM1uUvQwPSmu_Mxd5I194WF1KQn5Dz';
...
{
    $baseUrl = (isset($_SERVER['HTTPS']) ? "https://" : "http://") . $_SERVER['HTTP_HOST'] . "/DWebPHP/interfaz/pages/";
    ...
    $data = json_encode([
        ...
        "redirect_urls" => [
            "return_url" => $baseUrl . "pagoCompletado.html", // URL de retorno usando la variable base
            "cancel_url" => $baseUrl . "pagoCancelado.html" // URL de cancelación usando la variable base
        ]
    ]);
